class WritingsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @writing.save
        format.html do
          redirect_to writerview_writing_url(@writing), notice: 'Writing was successfully created.'
        end
  ...
  def update
    ...
    respond_to do |format|
      if @writing.update(writing_params)
        format.html do
          redirect_to writerview_writing_url(@writing), notice: 'Writing was successfully updated.', status: :see_other
        end
