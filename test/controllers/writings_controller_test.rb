...
class WritingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create writing" do
    assert_difference("Writing.count") do
      post writings_url, params: { writing: { content: @writing.content, title: @writing.title } }
    end
  ...
  test "should update writing" do
    patch writing_url(@writing), params: { writing: { content: @writing.content, title: @writing.title } }
